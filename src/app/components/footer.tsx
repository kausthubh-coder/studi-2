      ...
      <div className="mx-auto max-w-7xl px-6 py-12 md:py-16 lg:px-8">
        <Reveal>
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul className="mt-6 space-y-4">
                    ...
                    <li>
                      <Link href="#testimonials" className="text-sm leading-6 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                        Testimonials
                      </Link>
                    </li>
                    <li>
                      <Link href="/canvas-integration" className="text-sm leading-6 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                        Canvas Integration
                      </Link>
                    </li>
                    <li>
                      <Link href="/pricing" className="text-sm leading-6 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                        Pricing
                      </Link>
                    </li>
                  </ul>
                ...
                <div className="mt-10 md:mt-0">
                  ...
                  <ul className="mt-6 space-y-4">
                    <li>
                      <Link href="/help" className="text-sm leading-6 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                        Help Center
                      </Link>
                    </li>
                    <li>
                      <Link href="/guides" className="text-sm leading-6 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                        Study Guides
                      </Link>
                    </li>
                    <li>
                      <Link href="/blog" className="text-sm leading-6 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                        Blog
                      </Link>
                    </li>
                    <li>
                      <Link href="/api" className="text-sm leading-6 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                        API
                      </Link>
                    </li>
                  </ul>
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul className="mt-6 space-y-4">
                    ...
                    <li>
                      <Link href="/careers" className="text-sm leading-6 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                        Careers
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link href="/partners" className="text-sm leading-6 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                        Partners
                      </Link>
                    </li>
                  </ul>
                ...
                <div className="mt-10 md:mt-0">
                  ...
                  <ul className="mt-6 space-y-4">
                    ...
                    <li>
                      <Link href="/terms" className="text-sm leading-6 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                        Terms
                      </Link>
                    </li>
                    <li>
                      <Link href="/cookies" className="text-sm leading-6 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                        Cookie Policy
                      </Link>
                    </li>
                    <li>
                      <Link href="/licenses" className="text-sm leading-6 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                        Licenses
                      </Link>
                    </li>
                  </ul>
          ...
          <div className="mt-12 border-t border-gray-200 dark:border-gray-800 pt-8">
            <p className="text-sm text-gray-500 dark:text-gray-400 xl:text-center">
